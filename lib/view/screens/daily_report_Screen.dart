...
class DailyReport extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AttendanceController>(builder: (controller) {
      return controller.dailyReport.length > 0
          ? Column(
              children: [
                Padding(
                  padding:
                      ...
                      children: [
                        for (var i = controller.dailyReport.length - 1;
                          ...
                          ReportDataRow(
                            ...
                            check_in: i != controller.dailyReport.length - 1 ||
                                    controller.todayCheckIn.length == 0
                                ? controller.dailyReport[i]['CheckIn']
                                : controller.todayCheckIn,
                            check_out: controller.dailyReport[i]['CheckOut']
                                .toString(),
                            total_hours:
